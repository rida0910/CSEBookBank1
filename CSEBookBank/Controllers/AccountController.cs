...
namespace CSEBookBank.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            IUser user = context.Users.Find(model.Email);
            MyRole role = db.MyRoles.Find();
            var id = role.RoleId;

            if (id == "1")
            {
                RedirectToAction("Index", "Libraian");
            }
            if (id == "2")
            {
            ...
            {
                RedirectToAction("Index", "Librarian");
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Name, Email = model.Email,Name =model.Name,RegistrationNumber=model.RegistrationNumber };
